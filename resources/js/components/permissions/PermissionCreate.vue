    ...
    export default {
        ...
        methods: {
            ...
            crudDisplayName(item) {
                return this.permissionData.resource.substring(0, 1).toUpperCase() + this.permissionData.resource.substring(1) + ' ' + item.substring(0, 1).toUpperCase() + item.substring(1);
            },
        }
    }
</script>
