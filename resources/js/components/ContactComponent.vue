                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="text-danger" v-if="contactData.errors.has('name')"
                                v-html="contactData.errors.get('name')" />
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="text-danger" v-if="contactData.errors.has('email')"
                                v-html="contactData.errors.get('email')" />
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="text-danger" v-if="contactData.errors.has('message')"
                                v-html="contactData.errors.get('message')" />
                            </div>
                        </div>
                    </div>
