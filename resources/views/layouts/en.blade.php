...
<html lang="en">
  <head>
	...
	<link rel="stylesheet" href="{{ asset('sidebar/css') }}/bn_BD_style.css">
    @endif
  </head>
  <body>
			...
			<nav id="sidebar">
				<div class="p-4 pt-5">
                    ...
                    <ul class="list-unstyled components mb-5">
                        ...
                        @can('tasks-read')
                        <li class="{{ Request::is('task/index') ? 'active' : ''}}">
                            <a href="{{ route('task.index') }}">Assigned Tasks</a>
                        </li>
                        @endcan
                        ...
                        @can('reports-read')
                        <li class="{{ Request::is('task/reports') ? 'active' : ''}}">
                            <a href="{{ route('task.reports') }}">Reports</a>
                        </li>
                        @endcan
                    </ul>
