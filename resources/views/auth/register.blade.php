...
<div class="auth-card">
    <div class="row">
        <div class="col-md-12">
            <h3 class="text-center">Register To Login To Task Tracking</h3>
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('register') }}" method="POST">
                        ...
                        <div class="form-group my-1">
                            ...
                            value="{{ old('name') }}" placeholder="User Name" required autofocus>
                            @error('name')
                        ...
                        <div class="form-group my-1">
                            ...
                            value="{{ old('password') }}" placeholder="Password" autocomplete="new-password" required>
                            @error('password')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
