...
<div class="card">
    <div class="card-header bg-dark">
        <div class="row">
            ...
            <div class="col-md-6">
                @can('roles-create')
                <a href="{{ route('role.create') }}" class="btn btn-success float-right">Create New Role</a>
                @endcan
            </div>
        </div>
    </div>
                ...
                <form action="{{ route('role.search') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 d-flex align-items-center">
                            ...
                            @if (Request::is('role/search'))
                            <a href="{{ route('role.index') }}" class="btn btn-danger mt-3 mx-1">
